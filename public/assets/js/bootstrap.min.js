...
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
        ? (module.exports = e(require("popper.html")))
    ...
    var r,
        ...
        T =
            ...
            {
                set: function (t, e, n) {
                    void 0 === t.bsKey && ((t.bsKey = { key: e, id: a }), a++),
                        (r[t.bsKey.id] = n);
                },
                get: function (t, e) {
    ...
    var ht = "collapse",
        ...
        gt = (function () {
            ...
            return (
                ...
                (e._getConfig = function (t) {
                    return (
                        ((t = s({}, ft, t)).toggle = Boolean(t.toggle)),
                        v(ht, t, dt),
                        t
                    );
                }),
            ...
            return (
                ...
                (e.show = function () {
                    if (
                        ...
                        if (
                            !V.trigger(this._element, "show.bs.dropdown", i)
                                .defaultPrevented
                        ) {
                            if (!this._inNavbar) {
                                if (void 0 === n.default)
                            ...
                            if (
                                ...
                                if (n[i].classList.contains("show"))
                                    if (
                                        ...
                                        if (
                                            !V.trigger(s, "hide.bs.dropdown", a)
                                                .defaultPrevented
                                        ) {
                                            var c;
                                            if (
            ...
            return (
                ...
                (e._showElement = function (t) {
                    ...
                    var o = function () {
                        e._config.focus && e._element.focus(),
                            ...
                            V.trigger(e._element, "shown.bs.modal", {
                                relatedTarget: t,
                            });
                    };
                    if (n) {
                        var s = g(this._dialog);
                        V.one(this._dialog, "transitionend", o),
                            _(this._dialog, s);
                    } else o();
                }),
                ...
                (e._showBackdrop = function (t) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        ...
                        V.one(this._backdrop, "transitionend", t),
                            _(this._backdrop, i);
                        ...
                        if (this._element.classList.contains("fade")) {
                            ...
                            V.one(this._backdrop, "transitionend", o),
                                _(this._backdrop, s);
                        } else o();
                    } else t();
                }),
                ...
                (e.show = function () {
                    ...
                    if (
                        ...
                        if (
                            ...
                            V.one(this._element, "transitionend", e),
                                _(this._element, n);
                        } else e();
                    }
                }),
