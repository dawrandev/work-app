...
@section('content')
<x-breadcrumb :title="Profile" :description="fdsfsfdsa" :page="Profile"></x-breadcrumb>
                    ...
                    <div class="dashbord-sidebar">
                        <ul>
                            ...
                            <li><a href="manage-applications.html"><i class="lni lni-envelope"></i> Manage
                                    Applications</a></li>
                            <li><a class="active" href="manage-jobs.html"><i class="lni lni-briefcase"></i> Manage
                                    Jobs</a></li>
                            <li><a href="change-password.html"><i class="lni lni-lock"></i> Change Password</a></li>
                            <li><a href="index-2.html"><i class="lni lni-upload"></i> Sing Out</a></li>
                        </ul>
                    </div>
                </div>
                <!-- End Main Content -->
                    ...
                    <div class="job-items">
                        ...
                        <div class="manage-content">
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-12">
                                    <p><span class="time">Part-Time</span></p>
                                </div>
                                <div class="col-lg-3 col-md-3 col-12">
                                    <div class="can-img">
                                        <a href="#"><img src="assets/images/jobs/candidates.png" alt="#"></a>
