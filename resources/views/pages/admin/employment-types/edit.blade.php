...
@section('title', __('Edit Employment Type'))
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.employment-types.update', $employmentType->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="name_uz"
                                        name="name[uz]"
                                        value="{{ old('name.uz', $employmentType->name['uz'] ?? '') }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="name_ru"
                                        name="name[ru]"
                                        value="{{ old('name.ru', $employmentType->name['ru'] ?? '') }}"
