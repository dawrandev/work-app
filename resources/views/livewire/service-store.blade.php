    ...
    <div class="row">
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                ...
                <select name="category_id" wire:model.live="selectedCategory" class="select">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                ...
                <select name="subcategory_id" wire:model.live="selectedSubCategory" class="select" {{ empty($selectedCategory) ? 'disabled' : '' }}>
